...
<div class="wrapper wrapper-full-page">
    ...
    <div class="page-header login-page header-filter" filter-color="black"
         style="background-image: url('${context}/img/login.jpg'); background-size: cover; background-position: top center;">
        <!--   you can change the color of the filter page using: data-color="blue | purple | green | orange | red | rose " -->
        <div class="container">
            <div class="col-lg-4 col-md-6 col-sm-6 ml-auto mr-auto">
                <form class="form" method="post" action="${context}/app/web/login">
                    <div class="card card-login card-hidden">
                        ...
                        <div class="card-body ">
                            ...
                            <div style="text-align: center">
                                <label style="color: red;">${requestScope.webLoginBean.message}</label>
                            </div>
...
<!-- Sharrre libray -->
<%--<script src="${context}/demo/jquery.sharrre.js"></script>--%>
